      ...
      <div className="content">
        <div className="left">
          ...
          <h1>
            ...
            While working at <strong>Thelius Capital Partners</strong>, I was given an opportunity to develop internal software and fell in love with it.
            I code in <strong>Ruby, Ruby on Rails, JavaScript, React and Node</strong>.
          </h1>
